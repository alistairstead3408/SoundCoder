...
JNIEXPORT void JNICALL Java_com_stead_alistair_soundcoder_OpenCV_extractSURFFeature(
...
JNIEXPORT jbooleanArray JNICALL Java_com_stead_alistair_soundcoder_OpenCV_getSourceImage(
		JNIEnv* env, jobject thiz) {
	if (pImage == NULL) {
