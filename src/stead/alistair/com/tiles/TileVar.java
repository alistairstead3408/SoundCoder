 ...
 *
 */
public class TileVar extends Tile
{
	private static final String TAG = TileVar.class.getSimpleName();

	private Rect r;
	private float defaultValue;
	private float value = -1;
	
	public TileVar(Context context, int iconIDInput, float defaultValueInput, int tileWidth, int tileHeight) {
	...
	@Override
	public TileVar getClone()
	{
		return new TileVar(mContext, getIconID(), defaultValue, getTileWidth(), getTileHeight());
	}

	@Override
	public boolean equals(Object other)
	{
		TileVar otherGov = (TileVar) other;
